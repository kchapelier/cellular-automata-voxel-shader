...
var generateComment = function generateComment (what, rule, outOfBoundValue) {
    var comments = [
        '/**',
        ' * ' + what + ' generated by cellular-automata-voxel-shader 1.0.0',
        ' * ',
...
var generateGlsl = function generateGlsl (rule, neighbourhood, outOfBoundValue) {
    var glsl = [
        generateComment('Voxel Shader for MagicaVoxel 0.98', rule, outOfBoundValue),
        '',
